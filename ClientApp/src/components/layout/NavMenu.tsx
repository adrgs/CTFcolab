...
export class HeaderLink {
    ...
    constructor(label: string, link?: string, desc?: string, icon?: JSX.Element) {
        this.label = label;
        this.link = link;
        this.desc = desc;
        this.icon = icon;
...
const NavMenu = (props: Props) => {
    ...
    return (
        <div>
            <nav
                className={`bg-white dark:bg-gray-900 ${props.withShadow ? ' shadow' : ''}${props.isFat ? ' py-4' : ''
                    } `}
            >
                    ...
                    <div className="flex items-center justify-between h-16">
                        <div className={`${props.alignRight ? 'w-full justify-between' : ''} flex items-center`}>
                            <Link className="flex-shrink-0" to="/">
                                <img src="/img/logo-navbar.png" alt="CTFcolab" />
                            </Link>
                        ...
                        <div className="block">
                            <div className="ml-4 flex items-center md:ml-6">
                                ...
                                {props.ddmItems && props.ddmItems.map((item) => {
                                ...
                                <div className="ml-3 relative">
                                    <Ddm
                                        label={i18n.t("preferences").toString()}
                                        withBackground={false}
                                        forceOpen={props.forceDDMOpenInMobile}
                                        items={[
